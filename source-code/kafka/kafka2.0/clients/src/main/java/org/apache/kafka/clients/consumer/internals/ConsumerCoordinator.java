 ...
 */
public final class ConsumerCoordinator extends org.apache.kafka.clients.consumer.internals.AbstractCoordinator {
    private final Logger log;
    private final List<org.apache.kafka.clients.consumer.internals.PartitionAssignor> assignors;
    private final Metadata metadata;
    private final ConsumerCoordinatorMetrics sensors;
    private final org.apache.kafka.clients.consumer.internals.SubscriptionState subscriptions;
    private final OffsetCommitCallback defaultOffsetCommitCallback;
    private final boolean autoCommitEnabled;
    private final int autoCommitIntervalMs;
    private final org.apache.kafka.clients.consumer.internals.ConsumerInterceptors<?, ?> interceptors;
    ...
    private static class PendingCommittedOffsetRequest {
        ...
        private final org.apache.kafka.clients.consumer.internals.RequestFuture<Map<TopicPartition, OffsetAndMetadata>> response;
        ...
        private PendingCommittedOffsetRequest(final Set<TopicPartition> requestedPartitions,
                                              ...
                                              final org.apache.kafka.clients.consumer.internals.RequestFuture<Map<TopicPartition, OffsetAndMetadata>> response) {
    ...
    public ConsumerCoordinator(LogContext logContext,
                               ...
                               List<org.apache.kafka.clients.consumer.internals.PartitionAssignor> assignors,
                               Metadata metadata,
                               org.apache.kafka.clients.consumer.internals.SubscriptionState subscriptions,
                               Metrics metrics,
                               ...
                               org.apache.kafka.clients.consumer.internals.ConsumerInterceptors<?, ?> interceptors,
    ...
    public String protocolType() {
        return org.apache.kafka.clients.consumer.internals.ConsumerProtocol.PROTOCOL_TYPE;
    }
    ...
    public List<ProtocolMetadata> metadata() {
        ...
        for (org.apache.kafka.clients.consumer.internals.PartitionAssignor assignor : assignors) {
            Subscription subscription = assignor.subscription(joinedSubscription);
            ByteBuffer metadata = org.apache.kafka.clients.consumer.internals.ConsumerProtocol.serializeSubscription(subscription);
    ...
    private org.apache.kafka.clients.consumer.internals.PartitionAssignor lookupAssignor(String name) {
        for (org.apache.kafka.clients.consumer.internals.PartitionAssignor assignor : this.assignors) {
    ...
    protected void onJoinComplete(int generation,
        ...
        org.apache.kafka.clients.consumer.internals.PartitionAssignor assignor = lookupAssignor(assignmentStrategy);
        if (assignor == null)
            throw new IllegalStateException("Coordinator selected invalid assignment protocol: " + assignmentStrategy);

        Assignment assignment = org.apache.kafka.clients.consumer.internals.ConsumerProtocol.deserializeAssignment(assignmentBuffer);
    ...
    protected Map<String, ByteBuffer> performAssignment(String leaderId,
        ...
        for (Map.Entry<String, ByteBuffer> subscriptionEntry : allSubscriptions.entrySet()) {
            Subscription subscription = org.apache.kafka.clients.consumer.internals.ConsumerProtocol.deserializeSubscription(subscriptionEntry.getValue());
        ...
        for (Map.Entry<String, Assignment> assignmentEntry : assignment.entrySet()) {
            ByteBuffer buffer = org.apache.kafka.clients.consumer.internals.ConsumerProtocol.serializeAssignment(assignmentEntry.getValue());
    ...
    public Map<TopicPartition, OffsetAndMetadata> fetchCommittedOffsets(final Set<TopicPartition> partitions,
        ...
        while (true) {
            ...
            final org.apache.kafka.clients.consumer.internals.RequestFuture<Map<TopicPartition, OffsetAndMetadata>> future;
    ...
    public void commitOffsetsAsync(final Map<TopicPartition, OffsetAndMetadata> offsets, final OffsetCommitCallback callback) {
        ...
        if (!coordinatorUnknown()) {
            ...
            lookupCoordinator().addListener(new org.apache.kafka.clients.consumer.internals.RequestFutureListener<Void>() {
                @Override
    ...
    private void doCommitOffsetsAsync(final Map<TopicPartition, OffsetAndMetadata> offsets, final OffsetCommitCallback callback) {
        org.apache.kafka.clients.consumer.internals.RequestFuture<Void> future = sendOffsetCommitRequest(offsets);
        final OffsetCommitCallback cb = callback == null ? defaultOffsetCommitCallback : callback;
        future.addListener(new org.apache.kafka.clients.consumer.internals.RequestFutureListener<Void>() {
            @Override
            public void onSuccess(Void value) {
     ...
     */
    private org.apache.kafka.clients.consumer.internals.RequestFuture<Void> sendOffsetCommitRequest(final Map<TopicPartition, OffsetAndMetadata> offsets) {
        if (offsets.isEmpty())
            return org.apache.kafka.clients.consumer.internals.RequestFuture.voidSuccess();
        ...
        for (Map.Entry<TopicPartition, OffsetAndMetadata> entry : offsets.entrySet()) {
            ...
            if (offsetAndMetadata.offset() < 0) {
                return org.apache.kafka.clients.consumer.internals.RequestFuture.failure(new IllegalArgumentException("Invalid offset: " + offsetAndMetadata.offset()));
            }
        ...
        if (generation == null)
            return org.apache.kafka.clients.consumer.internals.RequestFuture.failure(new CommitFailedException());
    ...
    private class OffsetCommitResponseHandler extends CoordinatorResponseHandler<OffsetCommitResponse, Void> {
        ...
        @Override
        public void handle(OffsetCommitResponse commitResponse, org.apache.kafka.clients.consumer.internals.RequestFuture<Void> future) {
     ...
     */
    private org.apache.kafka.clients.consumer.internals.RequestFuture<Map<TopicPartition, OffsetAndMetadata>> sendOffsetFetchRequest(Set<TopicPartition> partitions) {
        Node coordinator = checkAndGetCoordinator();
        if (coordinator == null)
            return org.apache.kafka.clients.consumer.internals.RequestFuture.coordinatorNotAvailable();
    ...
    private class OffsetFetchResponseHandler extends CoordinatorResponseHandler<OffsetFetchResponse, Map<TopicPartition, OffsetAndMetadata>> {
        @Override
        public void handle(OffsetFetchResponse response, org.apache.kafka.clients.consumer.internals.RequestFuture<Map<TopicPartition, OffsetAndMetadata>> future) {
    ...
    private static class MetadataSnapshot {
        ...
        private MetadataSnapshot(org.apache.kafka.clients.consumer.internals.SubscriptionState subscription, Cluster cluster) {
