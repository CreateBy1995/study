...
public final class ProducerBatch {
    ...
    final org.apache.kafka.clients.producer.internals.ProduceRequestResult produceFuture;
    ...
    public ProducerBatch(TopicPartition tp, MemoryRecordsBuilder recordsBuilder, long now, boolean isSplitBatch) {
        ...
        this.produceFuture = new org.apache.kafka.clients.producer.internals.ProduceRequestResult(topicPartition);
        this.retry = false;
     ...
     */
    public org.apache.kafka.clients.producer.internals.FutureRecordMetadata tryAppend(long timestamp, byte[] key, byte[] value, Header[] headers, Callback callback, long now) {
        if (!recordsBuilder.hasRoomFor(timestamp, key, value, headers)) {
            ...
            org.apache.kafka.clients.producer.internals.FutureRecordMetadata future = new org.apache.kafka.clients.producer.internals.FutureRecordMetadata(this.produceFuture, this.recordCount,
                                                                   timestamp, checksum,
    ...
    public Deque<ProducerBatch> split(int splitBatchSize) {
        ...
        if (hasSequence()) {
            ...
            org.apache.kafka.clients.producer.internals.ProducerIdAndEpoch producerIdAndEpoch = new org.apache.kafka.clients.producer.internals.ProducerIdAndEpoch(producerId(), producerEpoch());
    ...
    final private static class Thunk {
        ...
        final org.apache.kafka.clients.producer.internals.FutureRecordMetadata future;

        Thunk(Callback callback, org.apache.kafka.clients.producer.internals.FutureRecordMetadata future) {
    ...
    public void setProducerState(org.apache.kafka.clients.producer.internals.ProducerIdAndEpoch producerIdAndEpoch, int baseSequence, boolean isTransactional) {
        recordsBuilder.setProducerState(producerIdAndEpoch.producerId, producerIdAndEpoch.epoch, baseSequence, isTransactional);
    }

    public void resetProducerState(org.apache.kafka.clients.producer.internals.ProducerIdAndEpoch producerIdAndEpoch, int baseSequence, boolean isTransactional) {
        reopened = true;
