...
public class ApiVersions {
    ...
    private final Map<String, org.apache.kafka.clients.NodeApiVersions> nodeApiVersions = new HashMap<>();
    private byte maxUsableProduceMagic = RecordBatch.CURRENT_MAGIC_VALUE;

    public synchronized void update(String nodeId, org.apache.kafka.clients.NodeApiVersions nodeApiVersions) {
    ...
    public synchronized org.apache.kafka.clients.NodeApiVersions get(String nodeId) {
    ...
    private byte computeMaxUsableProduceMagic() {
        ...
        for (org.apache.kafka.clients.NodeApiVersions versions : this.nodeApiVersions.values()) {
