 ...
 */
public class NetworkClient implements org.apache.kafka.clients.KafkaClient {
    ...
    private final org.apache.kafka.clients.MetadataUpdater metadataUpdater;

    private final Random randOffset;

    /* the state of each node's connection */
    private final org.apache.kafka.clients.ClusterConnectionStates connectionStates;

    /* the set of requests currently being sent or awaiting a response */
    private final org.apache.kafka.clients.InFlightRequests inFlightRequests;
    ...
    private final org.apache.kafka.clients.ApiVersions apiVersions;

    private final Map<String, ApiVersionsRequest.Builder> nodesNeedingApiVersionsFetch = new HashMap<>();

    private final List<org.apache.kafka.clients.ClientResponse> abortedSends = new LinkedList<>();
    ...
    public NetworkClient(Selectable selector,
                         ...
                         org.apache.kafka.clients.ApiVersions apiVersions,
    ...
    public NetworkClient(Selectable selector,
                         org.apache.kafka.clients.MetadataUpdater metadataUpdater,
                         String clientId,
                         int maxInFlightRequestsPerConnection,
                         long reconnectBackoffMs,
                         long reconnectBackoffMax,
    ...
    private NetworkClient(org.apache.kafka.clients.MetadataUpdater metadataUpdater,
                          Metadata metadata,
                          Selectable selector,
                          String clientId,
                          int maxInFlightRequestsPerConnection,
        ...
        this.inFlightRequests = new org.apache.kafka.clients.InFlightRequests(maxInFlightRequestsPerConnection);
        this.connectionStates = new org.apache.kafka.clients.ClusterConnectionStates(reconnectBackoffMs, reconnectBackoffMax);
    ...
    public void disconnect(String nodeId) {
        ...
        for (InFlightRequest request : inFlightRequests.clearAll(nodeId)) {
            if (request.isInternalRequest) {
                ...
                abortedSends.add(new org.apache.kafka.clients.ClientResponse(request.header,
     ...
     */
    @Override
    public void send(org.apache.kafka.clients.ClientRequest request, long now) {
        doSend(request, false, now);
    }

    private void sendInternalMetadataRequest(MetadataRequest.Builder builder,
                                             String nodeConnectionId, long now) {
        org.apache.kafka.clients.ClientRequest clientRequest = newClientRequest(nodeConnectionId, builder, now, true);
        doSend(clientRequest, true, now);
    }

    private void doSend(org.apache.kafka.clients.ClientRequest clientRequest, boolean isInternalRequest, long now) {
        ensureActive();
        ...
        if (!isInternalRequest) {
            ...
            // READY state.)
            // 检验请求要发送的broker节点对应的连接是否已经准备就绪
            if (!canSendRequest(nodeId, now))
                throw new IllegalStateException("Attempt to send a request to node " + nodeId + " which is not ready.");
        }
        AbstractRequest.Builder<?> builder = clientRequest.requestBuilder();
        try {
            org.apache.kafka.clients.NodeApiVersions versionInfo = apiVersions.get(nodeId);
            short version;
            ...
            org.apache.kafka.clients.ClientResponse clientResponse = new org.apache.kafka.clients.ClientResponse(clientRequest.makeHeader(builder.latestAllowedVersion()),
    ...
    private void doSend(org.apache.kafka.clients.ClientRequest clientRequest, boolean isInternalRequest, long now, AbstractRequest request) {
     ...
     */
    @Override
    public List<org.apache.kafka.clients.ClientResponse> poll(long timeout, long now) {
        ensureActive();
    ...
    private void completeResponses(List<org.apache.kafka.clients.ClientResponse> responses) {
        for (org.apache.kafka.clients.ClientResponse response : responses) {
            try {
                response.onComplete();
            } catch (Exception e) {
     ...
     */
    private void processDisconnection(List<org.apache.kafka.clients.ClientResponse> responses,
                                      String nodeId,
                                      long now,
     ...
     * @param now The current time
     */
    private void handleTimedOutRequests(List<org.apache.kafka.clients.ClientResponse> responses, long now) {
    ...
    private void handleAbortedSends(List<org.apache.kafka.clients.ClientResponse> responses) {
     ...
     * @param now The current time
     */
    private void handleCompletedReceives(List<org.apache.kafka.clients.ClientResponse> responses, long now) {
    ...
    private void handleApiVersionsResponse(List<org.apache.kafka.clients.ClientResponse> responses,
        ...
        org.apache.kafka.clients.NodeApiVersions nodeVersionInfo = new org.apache.kafka.clients.NodeApiVersions(apiVersionsResponse.apiVersions());
     ...
     * @param now The current time
     */
    private void handleDisconnections(List<org.apache.kafka.clients.ClientResponse> responses, long now) {
    ...
    private void handleInitiateApiVersionRequests(long now) {
        ...
        while (iter.hasNext()) {
            ...
            if (selector.isChannelReady(node) && inFlightRequests.canSendMore(node)) {
                ...
                org.apache.kafka.clients.ClientRequest clientRequest = newClientRequest(node, apiVersionRequestBuilder, now, true);
                doSend(clientRequest, true, now);
                iter.remove();
            }
        }
    ...
    class DefaultMetadataUpdater implements org.apache.kafka.clients.MetadataUpdater {
    ...
    @Override
    public org.apache.kafka.clients.ClientRequest newClientRequest(String nodeId,
    ...
    public org.apache.kafka.clients.ClientRequest newClientRequest(String nodeId,
                                                                   ...
                                                                   org.apache.kafka.clients.RequestCompletionHandler callback) {
        return new org.apache.kafka.clients.ClientRequest(nodeId, requestBuilder, correlation++, clientId, createdTimeMs, expectResponse,
    ...
    static class InFlightRequest {
        ...
        final org.apache.kafka.clients.RequestCompletionHandler callback;
        ...
        public InFlightRequest(org.apache.kafka.clients.ClientRequest clientRequest,
        ...
        public org.apache.kafka.clients.ClientResponse completed(AbstractResponse response, long timeMs) {
            return new org.apache.kafka.clients.ClientResponse(header, callback, destination, createdTimeMs, timeMs,
                    false, null, null, response);
        }

        public org.apache.kafka.clients.ClientResponse disconnected(long timeMs, AuthenticationException authenticationException) {
            return new org.apache.kafka.clients.ClientResponse(header, callback, destination, createdTimeMs, timeMs,
